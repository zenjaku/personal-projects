...
if(isset($_POST["SUBMIT"]))
{
    ...
    $tomaraoDif = $tomaraoNum1 - $tomaraoNum2;

//  insert the data into  table
//sql name = "INSERT INTO tableName VALUES ('$textBox','$textBox')";

    $renzo = "INSERT INTO subtraction 
              VALUES ('$tomaraoNum1', '$tomaraoNum2', '$tomaraoDif')";

// Check if the query is successful
    if (mysqli_query($tomarao, $renzo)) {
        echo "<table>";
        echo "<tr><td class='tomaraoSubmit'>The difference of the two numbers is: $tomaraoDif </td></tr>";
