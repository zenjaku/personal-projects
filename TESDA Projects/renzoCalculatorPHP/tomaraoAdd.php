...
if(isset($_POST["SUBMIT"]))
{
    ...
    $tomaraoSum = $tomaraoNum1 + $tomaraoNum2;

//  insert the data into  table
//sql name = "INSERT INTO tableName VALUES ('$textBox','$textBox')";

    $renzo = "INSERT INTO addition 
              VALUES ('$tomaraoNum1', '$tomaraoNum2', '$tomaraoSum')";

// Check if the query is successful
    if (mysqli_query($tomarao, $renzo)) {
        echo "<table>";
        echo "<tr><td class='tomaraoSubmit'>The sum of the two numbers is: $tomaraoSum </td></tr>";
