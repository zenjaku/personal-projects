...
// Check for division by zero
    if ($tomaraoNum2 == 0) {
        echo "<script> alert ('Error: Division by zero is not allowed!'); </script>";
        echo "<table>";
        echo "<tr><td colspan='2'>
                <form action='' method='GET'>
                    <button type='submit' class='tomaraoView'>Back</button>
                </form>
              </td></tr>";
        echo "</table";
    } else {
    $tomaraoQ = $tomaraoNum1 / $tomaraoNum2;

//  insert the data into  table
//sql name = "INSERT INTO tableName VALUES ('$textBox','$textBox')";

    $renzo = "INSERT INTO division 
              VALUES ('$tomaraoNum1', '$tomaraoNum2', '$tomaraoQ')";

// Check if the query is successful
    if (mysqli_query($tomarao, $renzo)) {
        echo "<table>";
        echo "<tr><td class='tomaraoSubmit'>The product of the two numbers is: $tomaraoQ </td></tr>";
        echo "<tr><td colspan='2'>
                <form action='' method='GET'>
