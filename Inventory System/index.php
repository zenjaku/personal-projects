    ...
    <div class="d-flex">
        ...
        <aside id="sidebar" class="sidebar-toggle">
            <div class="sidebar-logo">
                <a href="index.php?page=home"><img src="assets/p_1.png" class="img-fluid hpl_logo"></a>
            </div>
            <!-- Sidebar Navigation -->
            <ul class="sidebar-nav p-0">
                <?php if (isset($_SESSION['login']) && $_SESSION['login'] === true): ?>
                    ...
                    <li class="sidebar-item">
                        <a href="index.php?page=inventory" class="sidebar-link d-flex align-items-center gap-3">
                            <i class="fa-solid fa-chart-simple"></i>
                            <span>Inventory</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="index.php?page=allocate" class="sidebar-link d-flex align-items-center gap-3">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="index.php?page=employee" class="sidebar-link px-5">
                                    <span>Employee Data</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="index.php?page=db" class="sidebar-link px-5">
                                    <span>Backup Database</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <li class="sidebar-item">
                            <a href="index.php?page=register" class="sidebar-link px-5" title="Register">
                                <span>Register</span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="sidebar-footer d-flex flex-column gap-2">
                <?php if (!isset($_SESSION['login']) || $_SESSION['login'] !== true): ?>
                    <li class="sidebar-item">
                        <a href="index.php?page=login" class="sidebar-link d-flex align-items-center gap-3" title="Login">
                            <i class="fa-solid fa-user-lock"></i>
                            <span>Login</span>
                        </a>
                    </li>
                ...
                <?php if (isset($_SESSION['login']) && $_SESSION['login'] === true): ?>
                    <a href="index.php?page=logout" class="sidebar-link d-flex align-items-center gap-3" title="Logout">
        ...
        <div class="main" id="main">
            <nav class="navbar navbar-expand d-flex justify-content-between p-1">
                ...
                <div>
                    <h1 class="text-uppercase">HPL GAME DESIGN INVENTORY SYSTEM</h1>
                </div>
            </nav>
            <div class="py-3 px-5">
                <?php
